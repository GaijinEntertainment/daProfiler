...
namespace Profiler.Data
{
	...
	public class EventNode : TreeNode<EventDescription>
	{
		...
		public void ApplyTags(List<Tag> toAdd, ref int index)
		{
			...
			//Int64 EntryFinish = Entry.Start == Entry.Finish ? Entry.Finish : Entry.Finish - 1;
	...
	public class EventTree : EventNode
	{
		...
		public EventTree(EventFrame frame, List<Entry> entries) : base(null, new Entry(null, frame.Start, frame.Finish, -1) { Frame = frame })
		{
			this.frame = frame;
			BuildTree(entries);
