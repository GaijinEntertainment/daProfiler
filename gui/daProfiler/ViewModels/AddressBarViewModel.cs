...
namespace Profiler.ViewModels
{
    ...
    {
        const UInt16 DEFAULT_PORT = 31500;
        ...
        public String Icon
        {
            get
            {
                switch (Target)
                {
                    ...
                    case Platform.Type.win64:
                        return "appbar_os_windows_8";
                    case Platform.Type.win32:
                        return "appbar_os_windows_8";
                    case Platform.Type.linux64:
                    case Platform.Type.linux32:
                        return "appbar_os_ubuntu";
                    case Platform.Type.macosx:
                        return "appbar_social_apple";
                    case Platform.Type.xbox360:
                    case Platform.Type.xboxOne:
                    case Platform.Type.xboxScarlett:
                        return "appbar_controller_xbox";
                    case Platform.Type.ps3:
                    case Platform.Type.ps4:
                    case Platform.Type.ps5:
    ...
    class AddressBarViewModel : BaseViewModel
    {
        ...
        public void Load()
        {
            ...
            foreach (var ip in addresses)
                Connections.Add(new ConnectionVM() { Name = Environment.MachineName, Address = ip.ToString(), Target = Platform.Type.win64, CanDelete = false });
