...
namespace Profiler.Controls
{
	...
	public class LocalSettings
	{
        ...
        public string TempDirectoryPath => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "daProfiler\\Temp\\");
	...
	public class Settings
	{
		...
		private static SharedSettings<LocalSettings> localSettings = new SharedSettings<LocalSettings>("daProfiler.LocalConfig.xml", SettingsType.Local);
